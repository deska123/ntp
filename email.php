<?php
	...
	if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
		if($_SERVER['REQUEST_METHOD'] === 'POST') {
			if($_POST['command'] == 'checkingCaptcha') {
				session_start();

				$captchaText = $_POST['captchaTextInput'];
				$securimage = new Securimage();

				if ($securimage->check($_POST['captchaTextInput']) == false) {
					echo "not matched";
				} else {
					echo "matched";
				}
			} else if($_POST['command'] == 'sendingMessage') {
				...
				try {
				    ...
				    $mail2->Subject = 'Comments sent on ' . $dateTimeNow;
	  				...
	  				$confirmEmailBody = "
						...
						<img src=\"https://nariska.000webhostapp.com/ntp/assets/images/email.png\" alt=\"Email Image\" style=\"width:100%\">
